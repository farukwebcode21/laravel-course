                ...
                <footer class="w-full bg-dark-100 pt-[94px] relative">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <ul class="mt-5">
                                <li class="mb-2"><a href="{{route('archive',['series', 'laravel'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Laravel</a></li>
                                <li class="mb-2"><a href="{{route('archive',['series', 'php'])}}" class="text-links text-gray-100 text-base before:text-gray-100">PHP</a></li>
                                <li class="mb-2"><a href="{{route('archive',['series', 'livewire'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Livewire</a></li>
                                <li class="mb-2"><a href="{{route('archive',['series', 'vuejs'])}}"class="text-links text-gray-100 text-base before:text-gray-100">Vue.js</a></li>
                            </ul>
                        </div>
                        <div>
                            <h2 class="text-lg-primary text-white">Course by Duration</h2>
                            <ul class="mt-5">
                                <li class="mb-2"><a href="{{route('archive',['duration', '1-5-hours'])}}" class="text-links text-gray-100 text-base before:text-gray-100">1-5 hours</a></li>
                                <li class="mb-2"><a href="{{route('archive',['duration', '5-10-hours'])}}" class="text-links text-gray-100 text-base before:text-gray-100">5-10 hours</a></li>
                                <li class="mb-2"><a href="{{route('archive',['duration', '10-plus-hours'])}}" class="text-links text-gray-100 text-base before:text-gray-100">10+ hours</a></li>
                            </ul>
                        </div>
                        <div>
                            <h2 class="text-lg-primary text-white">Course by Level</h2>
                            <ul class="mt-5">
                                <li class="mb-2"><a href="{{route('archive',['level','beginner'])}}"class="text-links text-gray-100 text-base before:text-gray-100">Beginner</a></li>
                                <li class="mb-2"><a href="{{route('archive',['level','intermediate'])}}"class="text-links text-gray-100 text-base before:text-gray-100">Intermediate</a> </li>
                                <li class="mb-2"><a href="{{route('archive',['level','advanced'])}}"class="text-links text-gray-100 text-base before:text-gray-100">Advanced</a></li>
                            </ul>
                        </div>
                        <div>
                            <h2 class="text-lg-primary text-white">Course by Platform</h2>
                            <ul class="mt-5">
                                <li class="mb-2"><a href="{{route('archive',['platform','laracasts'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Laracasts</a></li>
                                <li class="mb-2"><a href="{{route('archive',['platform','laravel-daily'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Laravel Daily</a></li>
                                <li class="mb-2"><a href="{{route('archive',['platform','codecourse'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Codecourse</a></li>
                                <li class="mb-2"><a href="{{route('archive',['platform','spatie'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Spatie</a></li>
                            </ul>
                        </div>
                        <div>
                            <h2 class="text-lg-primary text-white">Course by Topics</h2>
                            <ul class="mt-5">
                                <li class="mb-2"><a href="{{route('archive',['topic','eloquent'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Eloquent</a></li>
                                <li class="mb-2"><a href="{{route('archive',['topic','validation'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Validation</a></li>
                                <li class="mb-2"><a href="{{route('archive',['topic','refactoring'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Refactoring</a></li>
                                <li class="mb-2"><a href="{{route('archive',['topic','testing'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Testing</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-base-primary text-sm text-[#E5E5E580] leading-5 z-50 relative">
                            Developed by <a href="#" target="_blank" class="hover:underline font-medium">Faruk Ahmad ⚡️</a>
                        </p>
                        <span></span>
                    </div>
        </footer>
